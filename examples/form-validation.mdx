...
```tsx
import { DInput, DButton } from '@dynamic-ui/react';
...
```tsx
import { DInputPassword, DPasswordStrengthMeter } from '@dynamic-ui/react';
import { useState } from 'react';
...
<Steps>
  ...
  <Step title="Build the form">
    ...
    ```tsx
    import { DInput, DSelect, DButton, DBox } from '@dynamic-ui/react';
...
```tsx
import { DInputCurrency, DButton } from '@dynamic-ui/react';
import { useState } from 'react';
...
```tsx
import { DInputCheck, DButton } from '@dynamic-ui/react';
import { useState } from 'react';
